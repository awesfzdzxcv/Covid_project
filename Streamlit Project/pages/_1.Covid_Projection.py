...
sys.path.append('/Users/Circe_1/Desktop/Build an interative dashboard/Streamlit Project')
...
deaths = pd.read_table('/Users/Circe_1/Desktop/Build an interative dashboard/Streamlit Project/PrepedData/deaths.csv',
                       sep=',', delimiter=None, header=0, encoding_errors='ignore')
