...
df_px = pd.read_table('/Streamlit-Project/PrepedData/Covid_Distance.csv',
...
fig.update_layout(
    title="Social distancing and Covid cases in different countries")

st.plotly_chart(fig)

df = pd.read_table('/Streamlit-Project/PrepedData/Covid_HK_Distance.csv',
...
fig_hk.update_layout(
    title="Social distancing and Covid cases in Hong Kong from 2020",
    xaxis_title="Dates",
